...
const dummyMeals = [
  Meal(
    ...
    steps: [
      ...
      'Enquanto isso, aqueça um pouco de azeite e junte a cebola cortada.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Faça camadas de presunto, abacaxi e queijo no pão branco',
  ...
  Meal(
    ...
    steps: [
      'Forme 2 hambúrgueres com a carne moída',
  ...
  Meal(
    ...
    steps: [
      ...
      'Corte o salmão',
      'Processe a mostarda, o vinagre e o azeite em um molho',
      'Prepare a salada',
  ...
  Meal(
    ...
    steps: [
      ...
      'Adicione o açucar e o suco de laranja',
  ...
  Meal(
    ...
    ingredients: [
      ...
      '2 Barras de chocolate amargo 70%, quebrado em pedaços',
    ...
    steps: [
      ...
      'Misture o leite frio até a mistura ficar lisa e engrossar. Transfira a mistura para uma tigela com o chocolate derretido.',
      ...
      'Adicione 1/3 do açúcar e bata. Adicione um pouco mais de açúcar por cerca de 15 segundos.',
      'misture o restante do açúcar. Continue batendo até que a mistura fique tão espessa quanto creme de barbear e mantenha picos suaves, 3 a 5 minutos.',
      ...
      'Asse em forno pré-aquecido até que as bordas estejam inchadas e subam acima do topo das bordas, 12 a 15 minutos.',
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: true,
